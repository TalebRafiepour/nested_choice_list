...
import 'package:nested_choice_list/src/nested_navigation_choice_list/nested_navigation_list_view.dart';
...
class NestedNavigationChoiceList extends StatefulWidget {
  const NestedNavigationChoiceList({
    required this.items,
  ...
  @override
  State<NestedNavigationChoiceList> createState() =>
      _NestedNavigationChoiceListState();
}

class _NestedNavigationChoiceListState
    extends State<NestedNavigationChoiceList> {
  ...
  void _onTapItem(NestedChoiceEntity item, BuildContext ctx) {
    if (item.hasChildren) {
      ...
      Navigator.of(ctx).push(
        MaterialPageRoute(
          builder: (context) {
            return InheritedNestedNavigationListView(
              selectedItems: selectedItems,
              child: NestedNavigationListView(
                items: item.children,
                ...
                child: Navigator(
                  ...
                  onGenerateRoute: (settings) {
                    return MaterialPageRoute(
                      builder: (_) => InheritedNestedNavigationListView(
                        selectedItems: selectedItems,
                        child: NestedNavigationListView(
                          items: widget.items,
                          searchfieldPosition: widget.searchfieldPosition,
